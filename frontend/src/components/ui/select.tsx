...
/* ------------------------------------------------------------------ *
 * Legacy native <select> — kept API: { options, label, error, placeholder }
 * ------------------------------------------------------------------ */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between gap-2 rounded-md border border-input bg-surface px-3 text-sm",
